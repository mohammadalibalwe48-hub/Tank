      ...
      child: Scaffold(
        ...
        body: StreamBuilder<List<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            final firstTank = tanks.isNotEmpty ? tanks.first : null;
            final currentVolume =
                firstTank != null ? (firstTank['current_volume'] ?? 0) : 0;
            final maxVolume =
                firstTank != null ? (firstTank['max_volume'] ?? 1000) : 1000;
            final percentage =
                maxVolume > 0 ? ((currentVolume / maxVolume) * 100).toInt() : 0;
            final status = firstTank != null
                ? (firstTank['status'] ?? 'UNKNOWN')
                : 'NO DATA';
            final weeklyAverage =
                firstTank != null ? (firstTank['weekly_average'] ?? 0) : 0;
                                                  ...
                                                  child: Stack(
                                                    ...
                                                    children: [
                                                      ...
                                                      Column(
                                                        ...
                                                        children: [
                                                          Text(
                                                            '${currentVolume} / ${maxVolume} Liters',
                                ...
                                Expanded(
                                  ...
                                  child: wrapWithModel(
                                    ...
                                    child: GlassStatCardWidget(
                                      ...
                                      label: 'Water Temp',
                                      value: firstTank != null
                                          ? '${firstTank['temperature'] ?? 18.2}°C'
                                          : '18.2°C',
                                    ),
                                  ),
                                ),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Weekly average: ${weeklyAverage}L/day',
                                      style: FlutterFlowTheme.of(context)
                                          .labelSmall
                                          .override(
                                            font: GoogleFonts.inter(
